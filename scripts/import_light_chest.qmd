...
Apparently,`KNUST_S006`, `KNUST_S007`, `KNUST_S009` `KNUST_S013` has some unlikely high measurement values and irregular data. Additionally, `KNUST_S012`, `KNUST_S014`, and `KNUST_S015` show irregular behavior.
...
data_cleaned <-
  ...
  group_modify( #regularize data
    \(dat,key) if(key$Id %in% c("KNUST_S006", "KNUST_S007", "KNUST_S009",
                                "KNUST_S012", "KNUST_S013", "KNUST_S014",
                                "KNUST_S015")) {
      dat |>  aggregate_Datetime("10 secs")
    } else dat
  ) |> 
...
data_cleaned |> gap_table() |> cols_hide(contains("_n"))
```
