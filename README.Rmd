...
![](images/logo.png){width=40%}
![](images/logo_with_text-01.png){width=40%}
...
> Akuffo, K.O., Agbeshie, G.K., Zauner, J., Spitschan, M. (2025). Personal light exposure dataset for Kumasi, Ghana [Dataset]. v1.0.0 doi: (to be added after archiving)
